    ...
    <section className="feedfill-page">
      <div className="feedfill-card feedfill-hero">
        <div>
          ...
          <p className="feedfill-description">
            Streamline the SRM Academia feedback routine with the SRM Academia Course Feedback Filler v1 by Krishna Somani. The tool focuses on the two inputs you actually need: Rating and Comment text.
          </p>
        </div>
      ...
      <div className="feedfill-card">
        <div className="feedfill-credit">
          Built with care by{' '}
          <a href="https://github.com/kr1shnasomani" target="_blank" rel="noreferrer noopener">
            Krishna Somani
          </a>.
